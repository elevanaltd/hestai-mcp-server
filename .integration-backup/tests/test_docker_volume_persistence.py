...
class TestDockerVolumePersistence:
    ...
    def test_docker_compose_volumes_configuration(self):
        ...
        assert "hestai-mcp-config:" in content, "hestai-mcp-config volume must be defined"
        ...
        assert "hestai-mcp-config:/app/conf" in content, "Config volume mount required"
    ...
    def test_volume_backup_restore_capability(self):
        ...
        assert "hestai-mcp-config:/data" in backup_cmd
...
class TestDockerVolumeIntegration:
    ...
    def test_docker_compose_run_volume_usage(self):
        ...
        compose_run_cmd = ["docker-compose", "run", "--rm", "hestai-mcp"]
