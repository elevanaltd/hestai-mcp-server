...
class SessionContextModel(BaseModel):
    ...
    @classmethod
    def from_session_context(cls, session_context) -> "SessionContextModel":
        """Create from SessionContext object."""
        return cls(session_id=session_context.session_id, project_root=session_context.project_root)
