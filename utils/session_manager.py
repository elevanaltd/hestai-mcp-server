...
class SessionManager:
    ...
    def __init__(
        ...
        if allowed_workspaces is None:
            # SECURITY: Default to a single, non-privileged path. Users MUST configure for production.
            self.allowed_workspaces = ["/var/mcp/workspaces"]
            logger.warning("Using default restricted workspace. Configure 'allowed_workspaces' for production.")
        else:
