...
def test_communication_simulator_fixes():
    ...
    try:
        ...
        if platform.system() == "Windows":
            ...
            expected_paths = [
                os.path.join(current_dir, ".hestai_venv", "Scripts", "python.exe"),
...
def test_base_simulator_test_fixes():
    ...
    try:
        ...
        if platform.system() == "Windows":
            # Test Windows path detection
            current_dir = os.getcwd()
            expected_path = os.path.join(current_dir, ".hestai_venv", "Scripts", "python.exe")
...
def test_shell_scripts_windows_support():
    ...
    try:
        ...
        try:
            ...
            has_windows_venv = 'elif [[ -f ".hestai_venv/Scripts/activate" ]]; then' in run_script_content
        ...
        try:
            ...
            has_windows_python = 'elif [[ -f ".hestai_venv/Scripts/python.exe" ]]; then' in quality_script_content
            has_windows_tools = 'elif [[ -f ".hestai_venv/Scripts/ruff.exe" ]]; then' in quality_script_content
