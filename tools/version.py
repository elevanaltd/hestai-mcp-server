"""
Version Tool - Display HestAI MCP Server version and system information

This tool provides version information about the HestAI MCP Server including
...
def fetch_github_version() -> Optional[tuple[str, str]]:
    ...
    github_url = "https://raw.githubusercontent.com/elevanaltd/hestai-mcp-server/main/config.py"
...
class VersionTool(BaseTool):
    """
    Tool for displaying HestAI MCP Server version and system information.
    ...
    async def execute(self, arguments: dict[str, Any]) -> list[TextContent]:
        """
        Display HestAI MCP Server version and system information.
        ...
        """
        output_lines = ["# HestAI MCP Server Version\n"]
